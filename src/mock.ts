...
export const mockSharedEpisodes = [
  "https://rickandmortyapi.com/api/episode/31",
];

export const mockUrlCharacters = "https://rickandmortyapi.com/api/character";

export const mockAllCharacters = {
  info: {
    count: 826,
    pages: 42,
...
export const mockMultipleCharacters = [
  {
    id: 1,
    name: "Rick Sanchez",
    status: "Alive",
